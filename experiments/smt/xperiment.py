...
def make_example_tasknet() -> TaskNet:
    ...
    heating = TaskDef(
        ...
        ident    = 1,
        priority = 1,
        startrng = IntRange(0, 300),
        endrng   = IntRange(0, 300),
        dur      = 80,
        start    = 10,
        after    = [],
        pre = [
   ...
   # Temporal properties:
    ...
    prop1 = TemporalProperty(
        name    = "always (battery >= 70)",
        formula = TLAlways(TLNumCmp("battery", ">=", 70.0)),
    )

    prop2 = TemporalProperty(
        name    = "always (driving -> eventually communicating)",
        formula = TLAlways(
            TLImplies(
    ...
    prop3 = TemporalProperty(
        name    = "always (driving -> once heating)",
        formula = TLAlways(
            TLImplies(
                TLStateIs("driving", "on"),
                TLOnce(TLStateIs("heating", "on")),
            )
        ),
    )
